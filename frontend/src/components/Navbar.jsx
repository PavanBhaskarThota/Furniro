...
export const Navbar = () => {
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems:'center', height:"100px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems:"center" , width:'12%' ,marginLeft:"56px"}}>
        <div>
          <img src={logo} alt="" />
        </div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between" , width:'28%'}}>
        <Link to={"/"} style={{fontSize:"16px" , textDecoration:"none", color:"black"}}>Home</Link>
        <Link to={"/shop"} style={{fontSize:"16px" , textDecoration:"none", color:"black"}}>shop</Link>
        <Link to={"/about"} style={{fontSize:"16px" , textDecoration:"none", color:"black"}}>about</Link>
        <Link to={"/contact"} style={{fontSize:"16px" , textDecoration:"none", color:"black"}}>contact</Link>
      </div>

      <div style={{ display: "flex", justifyContent: "space-between" , width:'13%', marginRight:'100px'}}>
        <div>
